...
def optimize_binary(binary_location:str, data_dir:str, output_dir:str):
...
def main():
    ...
    output_dir = f"/workspaces/torment-nexus/binaries/outputs"
    with gr.Blocks() as demo:
        ...
        optimize_button.click(fn=optimize_binary, inputs=[binary_location, gr.State(data_dir), gr.State(output_dir)])
